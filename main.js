    ...
    <div class="flex items-center justify-between">
      <div>
        <a class="text-white text-2xl font-bold" href="index.html">
          <span class="text-purple-400">Event</span>Verse
        </a>
      </div>
      <div class="hidden md:flex items-center space-x-6">
        ...
        <a class="text-gray-300 hover:text-white" href="schedule.html">Schedule</a>
        <a class="text-gray-300 hover:text-white" href="contact.html">Contact</a>
        <a href="contact.html" class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition duration-300">
          Register Now
        </a>
      </div>
      </div>
  </div>
</nav>// Loads navbar/footer, smooth scroll
